 ...
 * \brief Class for computing viscous term using average of gradient with correction (eN transition model).
 * \ingroup ViscDiscr
 * \author R. Roos.
 */
...
private:
  ...
  /*!
   * \brief eN transition model specific steps in the ComputeResidual method
