 ...
 * \brief Class for doing a scalar upwind solver for the eN transition model equations.
 * \ingroup ConvDiscr
 * \author R. Roos.
 */
...
private:
   ...
   */
  /*! Can be removed as this version of eN transition is based on SA turbulence model
